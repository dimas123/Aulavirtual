...
(function($) {
	...
	$.fn.lightBox = function(settings) {
		...
		settings = jQuery.extend({
			...
			imageBtnPrev:			'img/btnPrevious.png',			// (string) Path and the name of the prev button image
			imageBtnNext:			'img/btnNext.png',			// (string) Path and the name of the next button image
