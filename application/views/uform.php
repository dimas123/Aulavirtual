...
<head>
    ...
    <![endif]-->
<script type="text/javascript" src="/aulavirtual/nicedit/nicEdit.js"></script>
...
<div id="contenedor">
	...
	<div class="tr">
		...
		<div class="td"><?php echo form_input('contrasena', '','placeholder="contrase&ntilde;a", size="75"'); ?></div>
	</div>
	<div class="tr">
